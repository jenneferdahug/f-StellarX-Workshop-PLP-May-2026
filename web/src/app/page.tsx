        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg font-bold text-slate-900 tracking-tight">StellarX Dashboard</h1>
                <p className="text-[10px] uppercase tracking-widest text-slate-500 font-semibold">Testnet Environment</p>
              </div>
            </div>
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        {!publicKey && !connecting && (
          <div className="rounded-2xl border border-slate-200 bg-white py-24 text-center shadow-sm">
            ...
            <h2 className="text-xl font-semibold text-slate-900">Welcome to StellarX</h2>
            ...
            <div className="mt-8 flex justify-center gap-4">
              <a
                ...
                className="rounded-lg bg-slate-900 px-6 py-2.5 text-sm font-semibold text-white transition-all hover:bg-slate-800"
              >
                Get Freighter
              </a>
            </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              <section>
                <div className="mb-4 flex items-end justify-between">
                  <h2 className="text-sm font-bold uppercase tracking-wider text-slate-500">Wallet Overview</h2>
                  <button
                    onClick={refresh}
